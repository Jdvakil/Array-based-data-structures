...
/**
 * This class is designed to replicate the interface of an ArrayList.
 * 
...
public class ArrayList {
     ...
     * PRECONDITIONS: The user will insert a valid object at a valid index
     * POSTCONDITIONS: The object will be added at the desired index successfully.
     */
    public void insert(Object obj, int index) {
        if (obj != null && index >= 0 && index < this.size()) {
            // my friend helped me with this if statement and the bitwise operator right shift.
     ...
     * value.
     * I got help from my friend and online for this method, I went through the steps and understood how and why it works and then wrote
     * it down.
     * @param index the index of the object to be removed
     * @return the object removed 
     * PRECONDITIONS: The user will pass a valid index withing the range of the array. 
     * POSTCONDITIONS: The object at the given index will be removed and returned.
     */
    public Object remove(int index) {
        Object removedObject = -1;//if the index is not found
        if (index >= 0 && index < this.size()) {//validation if the index is out of range.
            removedObject = this.arrayList[index];//sets the removed value to a variable to be returned
            this.numOfElements--;//decreases the number of elements as one element is removed
            System.arraycopy(this.arrayList, index + 1, this.arrayList, index, this.numOfElements - index);//copies the array to itself 
     ...
     * PRECONDITIONS: The user will enter a valid index 
     * POSTCONDITIONS: The object will be returned
     */
    public Object get(int index) {
        Object ret = -1;
        if (index >= 0 && index < this.size()) {
            ret = this.arrayList[index];
        }
        return ret;
    }
     ...
     * @return
     * PRECONDITION: The user will enter an object that is not null
     ...
     * 
     * @param otherArrayList the other arrayList to be compared and determined if they are equal or not
     * @return equal or not.
     *PRECONDITIONS: The user will enter a valid Arraylist with valid elements
     *POSTCONDITIONS: The method will successfully check if two arraylists are equal or not
     */
